/**
 * Created by Liza on 007 07.12.16.
 */
    ...
    if (password.length < 6 && rating < 3) text = "Пароль слишком простой.Добавте спец" +
        " символы или буквы в верхнем регистре для увеличения сложности";
    ...
    else if (password.length >= 6 && rating == 1) text = "Пароль слишком простой";
